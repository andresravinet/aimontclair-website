    ...
    <section className="py-20 bg-slate-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          {/* Growth — featured */}
          <div className="bg-[#0D1B2A] rounded-2xl border border-brand/30 p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-200 relative">
            ...
            <div className="text-4xl font-bold font-display text-white mb-1">$1,500<span className="text-lg font-normal text-white/60">+</span></div>
            <div className="text-white/60 text-sm mb-6">Full automation suite</div>
            <ul className="space-y-3 mb-8">
            ...
            <Link to="/contact" className="block text-center py-2.5 px-4 bg-brand hover:bg-brand-dark text-white font-semibold rounded-lg transition-colors duration-200">
              Get My Free Audit
            </Link>
          </div>
        ...
        <div className="text-center">
          <p className="text-slate-500 text-sm">
            Not sure which fits? <Link to="/contact" className="text-brand font-medium hover:underline">Start with a free 30-minute audit</Link> &mdash; we&apos;ll recommend the right scope.
          </p>
        </div>
      </div>
    </section>
